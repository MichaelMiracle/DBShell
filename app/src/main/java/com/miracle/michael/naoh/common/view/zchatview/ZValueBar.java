package com.miracle.michael.naoh.common.view.zchatview;
...
import com.miracle.michael.naoh.databinding.ZValuebarBinding;

import java.util.List;

import static com.miracle.michael.naoh.common.view.zchatview.ZChatView.PRECISION;
...
public class ZValueBar extends LinearLayout {
    ...
    public void initValue(List<KData> data) {
        ...
        divisor = (int) (max * PRECISION - min * PRECISION);
    }
