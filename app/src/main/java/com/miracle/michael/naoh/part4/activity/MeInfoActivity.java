...
import com.miracle.michael.naoh.databinding.ActivityMeInfoBinding;
...
public class MeInfoActivity extends BaseActivity<ActivityMeInfoBinding> {
    ...
    private void uploadHeadimg(String path) {
        ...
        ZClientFootBall.getService(Service4.class).uploadHeadImg(userInfo.getUsername(), part).enqueue(new ZCallback<ZResponse>() {
            @Override
