package com.miracle.michael.naoh.part6.fragment;
...
import com.miracle.michael.naoh.databinding.Fragment6Binding;
import com.miracle.michael.naoh.part6.entity.PrizeInfoBean;
import com.miracle.michael.naoh.part6.entity.TrendBean;
import com.miracle.michael.naoh.part6.util.DDTrendChart;
import com.miracle.michael.naoh.part6.util.TrendData;
...
public class  Fragment6 extends BaseFragment<Fragment6Binding> implements DDTrendChart.ISelectedChangeListener {
    ...
    private List<List<TrendBean>> trendBean = new ArrayList<>();
    private int width = 0;
...
//        mTrendChart.setDrawLine(true);
    ...
    private final Handler mHandler = new Handler() {
        public void handleMessage(Message paramMessage) {
            ...
            Fragment6.this.mTrendChart.updateData("01", (ArrayList) paramMessage.obj);
        }
    };
