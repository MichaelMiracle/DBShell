...
import com.miracle.michael.naoh.databinding.ActivityRegisterBinding;
import com.miracle.michael.naoh.login.RegisterSuccessDialog;
...
//        }
        ...
        ZClientFootBall.getService(ServiceLogin.class).register(phoneNumber, password, userName).enqueue(new ZCallback<ZResponse<User>>() {
            @Override
